...
namespace GMOPaymentgGatewayDAL.GMOPGContext
{
    public class HiroshimaMaasDBContext: DbContext, IUnitOfWork
    {
        ////Payment Gateway Related
        public DbSet<BookedPassInformation> BookedPassInformations { get; set; }
        public DbSet<GMOPGConfiguration> GMOPGConfigurations { get; set; }
        ...
        protected HiroshimaMaasDBContext Context
        {
            get { return (HiroshimaMaasDBContext)this.UnitOfWork; }
        }
    }
