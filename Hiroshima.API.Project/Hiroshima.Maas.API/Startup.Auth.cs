...
using Hiroshima.Maas.DAL.Models;
...
namespace Hiroshima.Maas.API
{
    ...
    {
        private readonly IConfigurationRoot _appConfiguration1;
        private void ConfigureServicesAuth(IServiceCollection services)
        {

            services.AddDbContext<IdentityDbContext>(options =>
            {
                options.UseSqlServer(_appConfiguration1.GetConnectionString("AuthServer"));
